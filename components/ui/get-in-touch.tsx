...
export const ProfessionalConnect = () => {
  ...
  return (
    <section id="contact" className="relative bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden w-full py-24 sm:py-32">
      {/* Animated Background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-8">
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <button
            ...
            className="group relative inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25"
          >
